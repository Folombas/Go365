...
var (
	...
	motivations = []string{
		...
		"🚀 Сегодняшний отказ от CapCut = завтрашний MacBook Pro для кодинга на Go",
		...
		"🚫 Пальмы подождут. Сначала - работа в офисе с кондиционером, потом - занятия по видео-монтажу отпуска",
	}
