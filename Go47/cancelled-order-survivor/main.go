...
func printLegend(stats *Stats) {
	...
	fmt.Printf("║  электричку до Химок. Турникет был обесточен — прошёл,    ║\n")
	fmt.Printf("║  рискуя заблокировать карту. Доехал до Молжаниново,       ║\n")
	fmt.Printf("║  закрыл поездку, вернулся в Химки. А там — отмена!        ║\n")
